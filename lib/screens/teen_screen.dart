...
class TeenScreen extends StatefulWidget {
  @override
  _TeenScreenState createState() => _TeenScreenState();
}

class _TeenScreenState extends State<TeenScreen> {
  int _selectedIndex = 0;
  final List<Product> cartItems = []; // Корзина изначально пустая

  // Пример списка товаров для подростков
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Подростковый', style: TextStyle(color: Colors.white)),
